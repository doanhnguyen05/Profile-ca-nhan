                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-3 mb-4">
                        <span className="px-4 py-2 bg-blue-600 rounded-full text-sm font-medium">Công nghệ phần mềm</span>
              ...
              {[
                {
                  ...
                  title: 'Hệ thống sàng lọc theo triệu chứng',
                  description: 'Đây là đề tài báo cáo môn học. Xây dựng Web app hỗ trợ sàng lọc bệnh theo triệu chứng. Người dùng nhập thông tin cá nhân, triệu chứng, mức độ nghiêm trọng và thời gian xuất hiện; hệ thống dùng knowledge base và inference engine để suy luận, xếp hạng kết quả và lưu lịch sử sàng lọc.',
                  role: 'Phân tích bài toán sàng lọc dựa trên triệu chứng và xây dựng luồng người dùng nhập thông tin. Xây dựng chức năng nhập triệu chứng, chọn mức độ nghiêm trọng, thời gian mắc và xử lý câu hỏi follow-up. Tích hợp inference engine để suy luận kết quả dựa trên triệu chứng đã chọn. Thiết kế luồng lưu dữ liệu bệnh nhân và kết quả sàng lọc. Xây dựng giao diện Web. Viết báo cáo.',
                  tech: ['Python', 'Flask', 'Inference Engine', 'Knowledge Base', 'SQLite/PostgreSQL'],
                ...
                },
                {
                  ...
                  title: 'Mobile EduLMS - Ứng dụng học tập trực tuyến trên thiết bị di động',
                  description: 'Đây là dự án cuối môn học. Mobile EduLMS là ứng dụng di động hỗ trợ người học truy cập nội dung học tập, xem danh sách khóa học, theo dõi thông tin khóa học và sử dụng các chức năng cơ bản của hệ thống học tập trực tuyến trên thiết bị di động.',
                  role: 'Thiết kế giao diện ứng dụng mobile thân thiện với người dùng. Xây dựng các màn hình đăng nhập, danh sách khóa học, chi tiết khóa học và nội dung học tập. Phân tích luồng điều hướng giữa các màn hình. Tìm hiểu cách xử lý dữ liệu người dùng và tích hợp với hệ thống backend. Rèn luyện tư duy thiết kế trải nghiệm người dùng.',
                  tech: ['React Native', 'Expo', 'TypeScript', 'Tailwind CSS', 'API Integration', 'UI/UX'],
                ...
                },
                {
                  ...
                  title: 'Edu LMS - Hệ thống quản lý học tập trực tuyến',
                  description: 'Đây là đồ án cuối môn học. Edu LMS là hệ thống Web hỗ trợ quản lý đào tạo trực tuyến, phục vụ các nhóm người dùng gồm quản trị viên, giảng viên và người học. Hệ thống hỗ trợ quản lý khóa học, bài học, người dùng, tiến độ học tập và phân quyền theo vai trò.',
                  role: 'Phân tích yêu cầu và nghiệp vụ của hệ thống học tập trực tuyến. Thiết kế các chức năng chính cho Admin, Instructor và Learner. Xây dựng giao diện và chức năng quản lý khóa học, bài học, người dùng. Thiết kế cơ sở dữ liệu và luồng xử lý cho hệ thống. Áp dụng phân quyền người dùng theo vai trò. Viết báo cáo phân tích thiết kế.',
                  tech: ['ASP.NET MVC', 'Entity Framework Core', 'MySQL', 'ASP.NET Identity', 'Bootstrap 5', 'Docker'],
              ...
              {[
                {
                  ...
                  description: 'Đề tài tập trung nghiên cứu, thử nghiệm và đánh giá các tính năng bảo mật trên hai hệ quản trị cơ sở dữ liệu quan hệ MariaDB và PostgreSQL. Xây dựng ứng dụng Web quản lý hội thảo để kiểm chứng các cơ chế bảo mật trong môi trường thực tế.',
                  contribution: 'Tham gia nghiên cứu các cơ chế bảo mật trên MariaDB và PostgreSQL. Hỗ trợ phân tích các chức năng Authentication, Access Control, Encryption, Audit Logging và Backup/Recovery. Tham gia so sánh điểm mạnh, hạn chế. Hỗ trợ xây dựng ứng dụng Web thử nghiệm. Tham gia tổng hợp kết quả và viết báo cáo.',
                ...
                {
                  title: 'Hệ thống quản lý, lưu trữ và tìm kiếm tài liệu mã hóa trên Apache Spark & Elasticsearch',
                  description: 'Đề tài nghiên cứu các tính năng bảo mật trên nền tảng Apache Spark và Elasticsearch, đồng thời ứng dụng vào phát triển hệ thống Web quản lý, lưu trữ và tìm kiếm tài liệu được mã hóa.',
                  contribution: 'Tham gia nghiên cứu kiến trúc Apache Spark và Elasticsearch. Hỗ trợ phân tích mô hình Web quản lý tài liệu/hồ sơ nhạy cảm theo hướng bảo mật nhiều lớp. Tham gia mô tả luồng dữ liệu giữa Web Application, MySQL, Apache Spark và Elasticsearch. Hỗ trợ phân tích cơ chế tìm kiếm, kiểm soát truy cập và ghi nhật ký thao tác.',
